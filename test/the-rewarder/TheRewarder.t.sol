...
contract TheRewarderChallenge is Test {
     ...
     */
    function test_attacker_address() public view {
    ...
    function test_theRewarder() public checkSolvedByPlayer {
        ...
        //found by finding in json with address
        ...
        uint256 weth_times = weth.balanceOf(address(distributor)) /
            PLAYER_WETH_CLAIM;
        uint256 total = dvt_times + weth_times;
        ...
        console.log("DVT recovery:", dvt.balanceOf(recovery) / 1e18);
        console.log("WETH recovery:", weth.balanceOf(recovery) / 1e18);
    }
